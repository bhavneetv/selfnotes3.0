...
if (empty($_SESSION["User"]) && empty($_COOKIE["Edit_note"])) {


    header("Location: ../../public/login-sign.php");
    exit();
}
if (empty($_COOKIE["Edit_note"])) {


    header("Location: ../manageNote/manageNote.php");
    exit();
}
...
// code to get note id and get details
if(!empty($_COOKIE["Edit_note"])){
    $noteId = $_COOKIE["Edit_note"];
    $s = "SELECT * FROM all_notes WHERE id = $noteId";
    $stmt = $conn->prepare($s);
    $stmt->execute();
    ...
    if ($result->num_rows > 0) {
        ...
        $title = $row['title'];
        $subjectx = $row['subject'];
        $coursex = $row['course'];
        $type = $row['type'];
        $ch_num = $row['chapter'];
        $description = $row['description'];
        $main_topics = $row['topic_id'];
        // $file = $row['file'];
    } else {
        header("Location: ../manageNote/manage.php");
        exit();
    }
}
            ...
            <section class="max-w-2xl mx-auto">
                ...
                <form id="upload-form" class="space-y-6">
                    ...
                    <div>
                        ...
                        <select id="note-type" name="note-type" value="<?php echo $type; ?>" class="w-full p-3 border border-gray-300 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-300">
                            <option value="" disabled <?php if (empty($type)) echo 'selected'; ?>>Select Note Type</option>
                            <option value="imp" <?php if ($type == 'imp') echo 'selected'; ?>>Important Note</option>
                            <option value="notes" <?php if ($type == 'notes') echo 'selected'; ?>>Notes</option>
                            <option value="syb" <?php if ($type == 'syb') echo 'selected'; ?>>Syllabus</option>
                        </select>
                    </div>

                    <div id="title-container">
                        <label for="title" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2" id="title-label">Chapter </label>
                        <input type="text" id="title" value="<?php echo $title; ?>" name="title" class="w-full p-3 border border-gray-300 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-300" placeholder="Enter Chapter" required />
                    </div>
                    ...
                    <div id="description-container">
                        ...
                        <textarea id="description" name="description" rows="3" class="w-full p-3 border border-gray-300 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-300" placeholder="Enter description"><?php echo $description; ?></textarea>
                    </div>
                    ...
                    <div id="chapter-number-container">
                        ...
                        <input type="text" id="chapter-number" value="<?php echo $ch_num; ?>" name="chapter-number" class="w-full p-3 border border-gray-300 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-300" placeholder="Enter chapter number" />
                    </div>

                    <div>
                        <label for="course" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Course</label>
                        <select id="course" name="course" value="<?php echo $coursex; ?>" require class="w-full p-3 border border-gray-300 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-300">
                    ...
                    <div>
                        ...
                        <select id="subject" name="subject"  class="w-full p-3 border border-gray-300 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-300">
                    ...
                    <div id="main-topics-container">
                        ...
                        <textarea id="main-topics" name="main-topics" rows="3" class="w-full p-3 border border-gray-300 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-300" placeholder="Enter main topics"><?php echo $main_topics; ?></textarea>
                    </div>
